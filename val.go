...
type Validation interface {
	...
	Validate(ctx context.Context, value value.Value) (err error)
}
...
type Modifier interface {
	Validation
	Modify(ctx context.Context, value value.Value) (err error)
}

type ValidationFunc func(ctx context.Context, value value.Value) (err error)

func (vf ValidationFunc) Validate(ctx context.Context, value value.Value) (err error) {
	return
}
